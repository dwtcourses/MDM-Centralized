                        ...
                        <div class="animate fadeIn">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <iframe src="http://localhost:8000/ijepa/chart" height="550px" width="1100"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        {{--                        <div class="col-md-2">--}}
                        {{--                            {!! Form::select('data_source',['-1'=>'Select Data Source','BMDTP'=>'BMDTP','IJEPA'=>'IJEPA','LCGC_subkontraktor'=>'LCGC Sub Contractor','LCGC_supplier'=>'LCGC Supplier'],null,['class'=>'form-control','onChange'=>'form.submit()']) !!}--}}
                        {{--                        </div>--}}
                    ...
                    {!! Form::close() !!}
                    <form action="{{url('insert_ijepa')}}" method="post">
                        {{ csrf_field() }}
                        @if (session('error'))
