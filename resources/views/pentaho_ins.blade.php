                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                           ...
                           <?php
                                ...
                                $exec_job_insert = 'D:\pdi-ce-8.2.0.0-342\data-integration\kitchen.bat /file:"D:\Pentaho MDM 2.0\job_bodo_amattt.kjb" -level:"Basic"';
                                ...
                                //                                $exec_insert_master_data = 'E:\Pentaho\data-integration\pan.bat /file:"E:\Kuliah\TA\Backup Server\Pentaho\insert_data_master.ktr" -level:"Basic"';
                                ...
                                //                                shell_exec($exec_insert_master_data);
                                //
                                //                                $exec_sinkronisasi_master_data = 'E:\Pentaho\data-integration\pan.bat /file:"E:\Kuliah\TA\Backup Server\Pentaho\sinkronisasi_semua_data_aplikasi.ktr" -level:"Basic"';
                                //                                shell_exec($exec_sinkronisasi_master_data);
                                //
                                //                                $exec_lookup_master_data = 'E:\Pentaho\data-integration\kitchen.bat /file:"E:\Kuliah\TA\Backup Server\Pentaho\job_lookup_all_database_star_schema.kjb" -level:"Basic"';
                                //                                shell_exec($exec_lookup_master_data);

                                printf(shell_exec($exec_job_insert));
                                echo $exec_job_insert;
