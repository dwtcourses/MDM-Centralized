    ...
    <div class="container">
        <div class="col-md-8 offset-md-2">
            ...
            <div class="form-group row">
                {!! Form::label("data_source","data_source",["class"=>"col-form-label col-md-3 col-lg-2"]) !!}
                <div class="col-md-8">
                    {!! Form::select("data_source",['BMDTP'=>'BMDTP','IJEPA'=>'IJEPA','LCGC_subkontraktor'=>'LCGC Sub Contractor','LCGC_supplier'=>'LCGC Supplier'],null,["class"=>"form-control"]) !!}
                </div>
            </div>
            <div class="form-group row required">
